...
# print(Fore.RED + 'hii i am red color')
# print(Back.CYAN + 'this is back')
# print(Style.BRIGHT + "this is a bright text")
# print(Fore.RED + Back.LIGHTMAGENTA_EX + "this is mix of fore and back")
# print(f"{Fore.LIGHTBLUE_EX} lightblue")
